package qupath.lib.images.servers.omero.browser.browseserver;

import qupath.lib.images.servers.omero.common.api.clients.WebClient;
import qupath.lib.images.servers.omero.browser.browseserver.browser.Browser;

/**
 * Command that starts a {@link qupath.lib.images.servers.omero.browser.browseserver.browser browser}.
 */
