package qupath.lib.images.servers.omero.common.omeroentities.permissions;
...
public class Owner implements Comparable<Owner> {
    ...
    private static final Owner ALL_MEMBERS = new Owner(-1, resources.getString("Common.OmeroEntities.Owner.allMembers"), "", "", "", "", "");
    @SerializedName(value = "@id", alternate = "id") private int id;
    @SerializedName(value = "FirstName") private String firstName;
    @SerializedName(value = "MiddleName") private String middleName;
    @SerializedName(value = "LastName") private String lastName;
    @SerializedName(value = "Email") private String emailAddress;
    @SerializedName(value = "Institution") private String institution;
